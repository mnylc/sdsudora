    ...
    attach: function(context, settings) {
      ...
      if (!$(".soft-limit").hasClass('processed')) {
        $(".soft-limit").click(function(e) {
          // toggle class .shown, hidden stays hidden
          $(this).prev(".islandora-solr-facet").toggleClass('shown');
          // toggle class expanded
          $(this).toggleClass('expanded');
          // toggle class facet-scroll-enabled
          $(this).prev(".islandora-solr-facet").prev(".islandora-solr-facet").toggleClass('facet-scroll-enabled');
          var original_height = ($(this).prev(".islandora-solr-facet").prev(".islandora-solr-facet").height());
          if ($(this).prev(".islandora-solr-facet").hasClass('shown')) {
            // copy li elements to visible and add more class
	    $(this).prev(".islandora-solr-facet").prev(".islandora-solr-facet").append($(this).prev(".islandora-solr-facet").children().clone().addClass('more'));
            $(this).prev(".islandora-solr-facet").prev(".islandora-solr-facet").css({"max-height" : original_height});
          }
	  else {
           // Remove added li elements with more class
	   $(this).prev(".islandora-solr-facet").prev(".islandora-solr-facet").children("li").remove(".more");
          }
